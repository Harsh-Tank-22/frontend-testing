...
const RightSidebar = ({setRightexpanded}) => {
  return (
    <div className='w-[25%] h-screen m-6 rounded-2xl shadow-lg bg-gray-100 flex flex-col gap-4'>
        <div className='flex justify-between mx-7 my-4'>
            <div className='flex text-purple-700 gap-2'><FaPlus size={25} className='text-purple-700'/><p>Add</p></div>
            <div><button onClick={()=>setRightexpanded((prev)=>!prev)}>
        ...
        <div className='h-[40%] bg-white mx-4 rounded-md'>
            <img src={TradingImg} className='w-full h-full object-contain'></img>
        </div>
    </div>
  )
}
